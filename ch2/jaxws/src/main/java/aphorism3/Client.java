...
public class Client {
    ...
    private void init() throws Exception {
        ...
        this.service = Service.create(this.serviceName);
        this.service.addPort(this.portName , HTTPBinding.HTTP_BINDING , url);
    ...
    public void testProvider() throws Exception {
        this.init();
        Dispatch<Source> dispatch = this.service.createDispatch(this.portName , Source.class , Service.Mode.MESSAGE);
        ...
        System.out.println("Response ==> " + this.toXmlString(result));
    }

 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://services.web.javaee.offical.oralce/", wsdlLocation = "http://localhost:8080/WebService/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://services.web.javaee.offical.oralce/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://services.web.javaee.offical.oralce/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.web.javaee.offical.oralce/", "HelloPort"), Hello.class, features);
    }

 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "oralce.offical.javaee.web.services.client", wsdlLocation = "http://localhost:8081/WebService/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("oralce.offical.javaee.web.services.client", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/WebService/HelloService?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("oralce.offical.javaee.web.services.client", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("oralce.offical.javaee.web.services.client", "HelloPort"), Hello.class, features);
    }

...
public class BusTracker {
    ...
    private void demo(String key) {
        ...
        String url = BusTracker.baseUrl + "gettime" + key;
        this.makeRequest(url);

        url = BusTracker.baseUrl + "getvehicles" + key;
        this.makeRequest(url);

        String sampleRoute = "&rt=20&pid=954";
        url = BusTracker.baseUrl + "getpatterns" + key + sampleRoute;
        this.makeRequest(url);
    }
    ...
    private void makeRequest(String stringUrl) {
        ...
        this.report(stringUrl , response);
    }

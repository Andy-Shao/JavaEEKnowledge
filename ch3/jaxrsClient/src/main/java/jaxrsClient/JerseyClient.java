...
public class JerseyClient {
    ...
    private void demo() {
        ...
        WebResource resource = client.resource(JerseyClient.baseUrl);
        this.getAllDemo(resource);
        this.postDemo(resource); // same resource but different verb

        String url = JerseyClient.baseUrl + "?id=32";
        resource = client.resource(url);
        this.getOneDemo(resource);
        this.deleteDemo(resource); // delete id = 32
    }

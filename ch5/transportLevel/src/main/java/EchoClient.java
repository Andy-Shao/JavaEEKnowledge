...
public class EchoClient {
    ...
    private static void dump(Map map , String indent) {
        ...
        for (Object key : keys) {
            ...
            if (map.get(key) instanceof Map) EchoClient.dump((Map) map.get(key) , indent += "  ");
        }
    }
    ...
    public static void main(String[] args) {
         ...
         */
        String url = (args.length >= 2) ? (args[0] + args[1]) : EchoClient.defaultUrl;
        ...
        EchoClient.dump(responseContext , "");
    }
}